    ...
    <div className="min-h-screen bg-gray-100">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mb-8">
          <Link to="/prototypes/dashboard" className="bg-white p-4 rounded-lg shadow-sm border hover:border-blue-400 text-center transition duration-200">
            Dashboard
          </Link>
          <Link to="/prototypes/clients" className="bg-white p-4 rounded-lg shadow-sm border hover:border-blue-400 text-center transition duration-200">
            Clientes
          </Link>
          <Link to="/prototypes/professionals" className="bg-white p-4 rounded-lg shadow-sm border hover:border-blue-400 text-center transition duration-200">
            Profissionais
          </Link>
          <Link to="/prototypes/finance" className="bg-white p-4 rounded-lg shadow-sm border hover:border-blue-400 text-center transition duration-200">
            Financeiro e PDV
          </Link>
          <Link to="/prototypes/inventory" className="bg-white p-4 rounded-lg shadow-sm border hover:border-blue-400 text-center transition duration-200">
            Estoque
          </Link>
          <Link to="/prototypes/reports" className="bg-white p-4 rounded-lg shadow-sm border hover:border-blue-400 text-center transition duration-200">
            Relatórios
          </Link>
          <Link to="/prototypes/settings" className="bg-white p-4 rounded-lg shadow-sm border hover:border-blue-400 text-center transition duration-200">
            Configurações
          </Link>
        </div>
