...
// Import the fixed Onboarding component
const OnboardingContentFixed = React.lazy(() => 
  import("@/components/onboarding/OnboardingFixed").then(module => ({
    default: module.OnboardingFixed
  }))
);

const OnboardingFixedPage = () => {
...
export default OnboardingFixedPage;
