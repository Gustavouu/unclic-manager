...
// Testes de integrações externas para autenticação e autorização

describe('AuthService External Integrations', () => {
  ...
  it('deve enviar e-mail de recuperação de senha', async () => {
    await expect(
      authService.requestPasswordReset('test@business.com')
    ).resolves.not.toThrow();
  });

  it('deve enviar notificação de alteração de senha', async () => {
    // Login válido
