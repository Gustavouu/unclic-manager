  ...
  const setupSteps: SetupStep[] = [
    {
      ...
      description: hasBusinessInfo ? 'Configurado' : 'Pendente',
    ...
    },
    {
      ...
      description: hasBasicPermissions ? `${permissions.length} permissões` : 'Sem permissões',
    ...
    },
    {
      ...
      description: hasAdminAccess ? 'Acesso administrativo' : 'Acesso limitado',
      icon: <Users className="h-4 w-4" />,
      completed: hasAdminAccess || hasBasicPermissions
    },
    {
      id: 'ready',
      ...
      completed: hasBusinessInfo && hasBasicPermissions
    }
  ];
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-green-600">
                Tudo pronto! Você pode começar a usar todas as funcionalidades.
              </p>
            </div>
          </div>
        </CardContent>
      ...
      <CardHeader className="pb-4">
        <div className="flex items-center justify-between">
          <div>
            ...
            <CardDescription>
              {completedSteps} de {setupSteps.length} passos concluídos
            </CardDescription>
          </div>
        ...
        {!isFullySetup && (
          <div className="pt-2 border-t">
            <div className="flex items-center gap-2 text-sm text-amber-600">
              ...
              <span>
                Complete a configuração para acessar todas as funcionalidades
              </span>
            </div>
          </div>
        )}
